...
- `Makefile` with `lint` and `check` targets (markdownlint + doc-audit)
- `.markdownlint-cli2.jsonc` for governance Markdown linting (`info/` and `staff/` excluded)

### Changed

- Governance Markdown formatting aligned with markdownlint rules
